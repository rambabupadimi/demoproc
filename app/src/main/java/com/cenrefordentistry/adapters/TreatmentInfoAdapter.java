...
public class TreatmentInfoAdapter extends RecyclerView.Adapter<TreatmentInfoAdapter.CustomViewHolder> implements AppConstants{
    ...
    public void onBindViewHolder(final CustomViewHolder holder, int position) {
        ...
        final TreatmentInfoModel treatmentInfoModel = treatmentInfoModelList.get(position);
            ...
            Log.i("tag", "color - code" + treatmentInfoModel.getTreatment_type_code());
            Log.i("tag", "color name" + treatmentInfoModel.getTreatment_type_colour());
            ...
            } else if (color.equalsIgnoreCase("DGC")) {
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public CustomViewHolder(View itemView) {
            ...
            moreInfoText    =   (TextView)itemView.findViewById(R.id.more_info_text);
            moreInfoIcon    =   (ImageView) itemView.findViewById(R.id.more_info_icon);
         }
    }
